            ...
            <div className='mt-[90px] flex flex-wrap -mx-4'>
              ...
              <div className='flex-none w-1/2 md:w-1/4 max-w-1/2 md:max-w-1/4 relative min-h-px px-4'>
                ...
                <div className='text-center font-normal text-[24px]/[36px] text-[#163b56]'>
                  ...
                  <span className='line-clamp-3 font-normal text-[24px]/[36px] text-[#163b56]'>Tự do sáng tác, đa dạng, hấp dẫn</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className='bg-[#f4faf6]'>
        ...
        <div className='flex justify-center'>
          <div className='ml-5 w-[285px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            ...
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Chính trị & xã hội</span>
          </div>
          <div className='ml-5 w-[215px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Tâm lý học</span>
          </div>
          <div className='ml-5 w-[209px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Khoa học</span>
          </div>
        </div>
        <div className='flex justify-center mt-4'>
          <div className='ml-5 w-[308px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            ...
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Tiểu sử và lịch sử</span>
          </div>
          <div className='ml-5 w-[350px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Sức khỏe và thể hình</span>
          </div>
          <div className='ml-5 w-[339px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Văn hóa doanh nghiệp</span>
          </div>
        </div>
        <div className='flex justify-center mt-4'>
          <div className='ml-5 w-[612px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            ...
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Tính thần khởi nghiệp & Doanh nghiệp nhỏ</span>
          </div>
          <div className='ml-5 w-[431px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Động lực và Truyền cảm hứng</span>
          </div>
        </div>
        <div className='flex justify-center mt-4'>
          <div className='ml-5 w-[219px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            ...
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Kinh tế học</span>
          </div>
          <div className='ml-5 w-[274px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Quản lý lãnh đạo</span>
          </div>
          <div className='ml-5 w-[305px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Tiền bạc và đầu tư</span>
          </div>
        </div>
        <div className='flex justify-center mt-4'>
          <div className='ml-5 w-[546px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            ...
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Hiệu suất làm việc và Quản lý thời gian</span>
          </div>
          <div className='ml-5 w-[612px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Phát triển cá nhân và tự hoàn thiện bản thân</span>
          </div>
        </div>
        <div className='flex justify-center mt-4 pb-15'>
          <div className='ml-5 w-[359px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            ...
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Marketing và bán hàng</span>
          </div>
          <div className='ml-5 w-[375px] h-[71px] bg-white rounded-[10px] flex justify-center items-center'>
            <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
              <Image src={'/ic_tower.svg'} width={30} height={30} alt='' />
            </span>
            <span className='font-normal lg:text-[24px]/[17px] md:text-[20px]/[17px] text-[14px]/[12px] -tracking-[.01em] text-[#163b56] '>Giới tính và mối quan hệ</span>
          </div>
        </div>
      </div>
              ...
              <div className='mt-8'>
                <div className='flex items-center mt-9'>
                  ...
                  <div className='ml-4 w-full'>
                    <span className='font-normal md:text-[20px]/[30px] text-[16px]/[20px]'>Mở khóa toàn bộ sách<b> 1 năm/trọn đời</b></span>
                  </div>
                </div>
                <div className='flex items-center mt-9'>
                  <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
                  ...
                  <div className='ml-4 w-full'>
                    <span className='font-normal md:text-[20px]/[30px] text-[16px]/[20px]'>Đọc và nghe hơn <b>2500 cuốn sách cùng 16 thể loại</b> khác nhau</span>
                  </div>
                </div>
                <div className='flex items-center mt-9'>
                  <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
                  ...
                  <div className='ml-4 w-full'>
                    <span className='font-normal md:text-[20px]/[30px] text-[16px]/[20px]'>Dễ dàng tiếp thu tri thức từ<b> 5 cuồn sách mỗi ngày</b></span>
                  </div>
                </div>
                <div className='flex items-center mt-9'>
                  <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
                  ...
                  <div className='ml-4 w-full'>
                    <span className='font-normal md:text-[20px]/[30px] text-[16px]/[20px]'>Xem thỏa thích những video hay về sách<b> không</b> bị làm phiền bởi<b> quảng cáo</b></span>
                  </div>
                </div>
                <div className='flex items-center mt-9'>
                  <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
                  ...
                  <div className='ml-4 w-full'>
                    <span className='font-normal md:text-[20px]/[30px] text-[16px]/[20px]'><b>Đọc miễn phí</b> chương đầu tiên với các <b>truyện độc quyền</b></span>
                  </div>
                </div>
                <div className='flex items-center mt-9'>
                  <span className='box-border inline-block overflow-hidden w-[initial] h-[initial] opacity-100 m-0 p-0 relative max-w-full'>
                  ...
                  <div className='ml-4 w-full'>
                    <span className='font-normal md:text-[20px]/[30px] text-[16px]/[20px]'>Tham gia vào các sự kiện<b> kiếm Rtoken</b></span>
                  </div>
                </div>
              </div>
            </div>
                              ...
                              <label className='w-full text-[14px] m-0 p-0 text-[rgba(0,0,0,0.85)] inline-flex items-baseline cursor-pointer'>
                                ...
                                <span className='w-full justify-between flex items-center px-2'>
                                  ...
                                  <div className='h-8 flex items-center'>
                                    <span className='box-border overflow-hidden w-[initial] m-0 p-0 relative max-w-full  hidden md:inline-block z-2'>
                            ...
                            <div className='border border-[#33bf71] box-border rounded-[10px] h-[49px] w-[236px] flex items-center lg:mt-[39px] mt-5 flex-none basis-5/12 max-w-5/12 relative min-h-px px-4 ml-auto'>
                              <label className='w-full text-[14px] m-0 p-0 text-[rgba(0,0,0,0.85)] inline-flex items-baseline cursor-pointer'>
                                ...
                                <span className='w-full justify-between flex items-center px-2'>
                                  <div>Instagram</div>
                                  <div className='h-8 flex items-center'>
                                    <span className='box-border overflow-hidden w-[initial] m-0 p-0 relative max-w-full z-2 hidden md:inline-block '>
                            ...
                            <div className='border border-[#33bf71] box-border rounded-[10px] h-[49px] w-[236px] flex items-center lg:mt-[39px] mt-5 flex-none basis-5/12 max-w-5/12 relative min-h-px px-4'>
                              <label className='w-full text-[14px] m-0 p-0 text-[rgba(0,0,0,0.85)] inline-flex items-baseline cursor-pointer'>
                                ...
                                <span className='w-full justify-between flex items-center px-2'>
                                  <div>Facebook</div>
                                  <div className='h-8 flex items-center'>
                                    <span className='box-border overflow-hidden w-[initial] m-0 p-0 relative max-w-full z hidden md:inline-block -2'>
        ...
        <div className={styles.container}>
          <div className='pb-24 flex flex-wrap -mx-4'>
            <div className='mt-[95px] flex-none w-5/12 max-w-5/12 relative min-h-px px-4'>
              ...
              <h6 className='mt-8 font-normal md:text-[20px]/[30px] text-[16px]/[20px] text-white w-[80%] mb-[.5em]'>Tòa Licogi 13, Khuất Duy Tiến, Thanh Xuân, Hà Nội</h6>
