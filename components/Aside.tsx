                                ...
                                <div className='flex h-fit'>
                                    <div className='flex items-center'>
                                        <div className={`w-8 h-8 ${pathname === '/' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'} rounded-xl mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                            <Image src={'/Home.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex h-fit'>
                                    <div className='flex items-center'>
                                        <div className={`w-8 h-8 ${pathname === '/introduce' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-xl mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                            <Image src={'/ic_puzzle.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex h-fit'>
                                    <div className='flex items-center'>
                                        <div className={`w-8 h-8 ${pathname === '/collection' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-xl mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                            <Image src={'/bookmark.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex h-fit'>
                                    <div className='flex items-center'>
                                        <div className={`w-8 h-8 ${pathname === '/bookfree' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-xl mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                            <Image src={'/bookfree.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex h-fit'>
                                    <div className='flex items-center'>
                                        <div className={`w-8 h-8 ${pathname === '/selection' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-xl mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                            <Image src={'/rating.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                        </div>
                                    </div>
                                ...
                                <div className='flex h-fit'>
                                    <div className='flex items-center'>
                                        <div className={`w-8 h-8 ${pathname === '/trending' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-xl mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                            <Image src={'/ic_wallet.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                        </div>
                                    </div>
                        ...
                        <ul className='pt-12.5 overflow-x-hidden rounded-r-[inherit]!'>
                            <li className='p-0 mb-2 mt-1 h-10 menu-item'>
                                <Link href={'/'}>
                                    <div className='flex h-fit'>
                                        <div className='flex items-center'>
                                            <div className={`w-8 h-8 ${pathname === '/' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'} rounded-[7px] mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                                <Image src={'/Home.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li className='p-0 mb-2 mt-1 h-10 menu-item'>
                                <Link href={'/introduce'}>
                                    <div className='flex h-fit'>
                                        <div className='flex items-center'>
                                            <div className={`w-8 h-8 ${pathname === '/introduce' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-[7px] mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                                <Image src={'/ic_puzzle.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li className='p-0 mb-2 mt-1 h-10 menu-item'>
                                <Link href={'/collection'}>
                                    <div className='flex h-fit'>
                                        <div className='flex items-center'>
                                            <div className={`w-8 h-8 ${pathname === '/collection' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-[7px] mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                                <Image src={'/bookmark.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li className='p-0 mb-2 mt-1 h-10 menu-item'>
                                <Link href={'/bookfree'}>
                                    <div className='flex h-fit'>
                                        <div className='flex items-center'>
                                            <div className={`w-8 h-8 ${pathname === '/bookfree' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-[7px] mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                                <Image src={'/bookfree.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li className='p-0 mb-2 mt-1 h-10 menu-item'>
                                <Link href={'/selection'}>
                                    <div className='flex h-fit'>
                                        <div className='flex items-center'>
                                            <div className={`w-8 h-8 ${pathname === '/selection' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-[7px] mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                                <Image src={'/rating.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li className='p-0 mb-2 mt-1 h-10 menu-item'>
                                <Link href={'/trending'}>
                                    <div className='flex h-fit'>
                                        <div className='flex items-center'>
                                            <div className={`w-8 h-8 ${pathname === '/trending' ? 'bg-[#33bf71] active' : 'bg-[#1c465d]'}  rounded-[7px] mr-4 mb-auto mt-auto px-2 py-0 flex justify-center`}>
                                                <Image src={'/ic_wallet.svg'} width={20} height={20} alt='' className='filter brightness-0 invert' />
                                            </div>
                                        </div>
                                    </div>
