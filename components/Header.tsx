                    ...
                    <div className='w-[60%]!'>
                        <div className='w-full flex items-center'>
                            <div className='w-full! rounded-[10px]! bg-[#1c465d]! h-10 px-[11px] py-1 transition-all duration-500 ease-in inline-flex'>
                                <input type="text" placeholder='Tìm Kiếm' className='text-white text-[16px]/[13px] font-Regular text-ellipsis touch-manipulation w-full transition-all duration-500 ease-in' />
